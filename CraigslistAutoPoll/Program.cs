...
namespace CraigslistAutoPoll
{
    static class Program
    {
        ...
        static void Main()
        {
            ...
            {
                ServiceController sc = ServiceController.GetServices().FirstOrDefault(x => x.ServiceName == "Craigslist Crawler");
                ...
                while (true)
                {
                    ...
                    switch (cmd.ToLower())
                    {
                        case "install":
                            ...
                            sc = ServiceController.GetServices().FirstOrDefault(x => x.ServiceName == "Craigslist Crawler");
                            break;
                        case "uninstall":
                            if (sc == null)
                            {
